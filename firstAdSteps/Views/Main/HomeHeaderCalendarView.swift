...
struct HomeHeaderCalendarView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            HStack(alignment: .center, spacing: 24) {
                ...
                SemiCircleProgressBarCalendar(progress: remainingKcal / totalKcal)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    MacroBarCalendarView(title: "CARBS", value: carbs, maxValue: 150, color: .orange)
                    MacroBarCalendarView(title: "PROTEIN", value: protein, maxValue: 60, color: .pink)
                    MacroBarCalendarView(title: "FAT", value: fat, maxValue: 30, color: .green)
                }
                .frame(width: 100)
            }
        }
...
struct SemiCircleProgressBarCalendar: View {
...
struct MacroBarCalendarView: View {
    let title: String
    let value: Double
    let maxValue: Double
    let color: Color
